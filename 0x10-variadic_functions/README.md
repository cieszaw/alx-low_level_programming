...
File variadic_functions.h is the header file that contains all the function prototypes.File 0-sum_them_all.c is a function that returns the sum of all its parameters.
